    ...
    <div class="registration-card status-{{ $registrationStatus }}">
        ...
        @if($registrationStatus === 'pending')
            <div class="countdown-container">
                ...
                <p class="instruction-text">
                    Registration will open on {{ date('F j, Y', strtotime($startDate)) }}
                </p>
            </div>
        ...
        @elseif($registrationStatus === 'open')
            ...
            <div class="registration-content">
                <p class="instruction-text">
                    Scan the QR code below to register instantly or use the Google Form link
                </p>

                <div class="qr-container">
                    <a href="YOUR_REGISTRATION_LINK" target="_blank">
                        <img src="{{asset('user_view/images/projectqr.png')}}" alt="QR Code" class="qr-code">
                    </a>
                </div>

                <p class="instruction-text">
                    Prefer traditional form? Click below to register via Google Form
                </p>

                <a href="GOOGLE_FORM_LINK" class="google-form-btn">
                    <!-- Google Form SVG -->
        ...
        @else
            ...
            <p class="instruction-text" style="color: #666; margin-top: 1rem;">
                The registration period ended on {{ date('F j, Y', strtotime($endDate)) }}
            </p>
        @endif
    </div>
</div>
...
<script>
    ...
    const deadline = new Date("{{ $registrationStatus === 'pending' ? $startDate : $endDate }}").getTime();
