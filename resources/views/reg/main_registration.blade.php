...
<body>
    ...
    <div class="container py-5">
        <div class="text-center mb-5">
            <h1 class="display-5 fw-bold text-dark">Registration</h1>
            <p class="text-muted">Registration is open</p>
        </div>
    </div>
    <div class="container my-5 py-5">
        <div class="row justify-content-center">
            ...
            <div class="col-12 col-sm-6 col-lg-4 mb-4">
                <a href="{{url('/registration')}}" class="card option-card bg-dark text-white">
                    <div class="card-body text-center py-5">
                        <i class="fas fa-trophy fa-4x mb-4"></i>
                        <h3 class="card-title mb-3">HSTU RDPC</h3>
                        <p class="card-text">Join the programming competition</p>
                    </div>
                </a>
            </div>
            ...
            <!-- Project Showcasing -->
            <div class="col-12 col-sm-6 col-lg-4 mb-4">
                <a href="{{url('project-showcase')}}" class="card option-card bg-dark text-white">
                    <div class="card-body text-center py-5">
            ...
            <!-- IT Quiz -->
            <div class="col-12 col-sm-6 col-lg-4 mb-4">
                <a href="{{url('itquiz')}}" class="card option-card bg-dark text-white">
                    <div class="card-body text-center py-5">
